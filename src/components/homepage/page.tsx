    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <div>
        <div>
          ...
          <p className="text-xl text-center text-gray-600 mb-8">
            Unleash the power of the written word and use our journaling feature
            to unravel the complexities of your mind.
          </p>
        </div>
      ...
      <div>
        <div>
          ...
          <p className="text-xl text-center text-gray-600 mb-8">
            Our app offers a curated collection of calming experiences, allowing
            you to find solace, recharge your energy, and cultivate a sense of
            inner peace whenever you need it.
          </p>
        </div>
